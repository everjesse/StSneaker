...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function changeCity()
	{
	document.getElementById("city").value=document.getElementById("cmbCity").value;
	...
	{
	document.getElementById("province").value=document.getElementById("cmbProvince").value;
